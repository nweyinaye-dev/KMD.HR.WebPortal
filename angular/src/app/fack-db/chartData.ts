...
export class ChartDB {
  ...
  static bar2CAC = {
    ...
    colors: ['#4B2E2B', '#0e9e4a', '#FFB64D', '#FF5370'],
    responsive: [
      {
        breakpoint: 480,
        options: {
  ...
  static bar4CAC = {
    ...
    colors: ['#4B2E2B', '#00acc1', '#0e9e4a', '#FFB64D', '#FF5370'],
    stroke: {
      width: 1,
      colors: ['#fff']
    },
  ...
  static scatter1CAC = {
    ...
    colors: ['#4B2E2B', '#0e9e4a', '#FF5370', '#FFB64D', '#00acc1'],
    series: [
      {
        name: 'SAMPLE A',
        data: [
  ...
  static pie1CAC = {
    ...
    colors: ['#4B2E2B', '#0e9e4a', '#00acc1', '#FFB64D', '#FF5370'],
    legend: {
      show: true,
      position: 'bottom'
    },
